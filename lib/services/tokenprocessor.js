...
exports.logDeniedUser = function(user, door_id, token, reason, cb) {
  ...
  doorserver.repositories.logRepository.logDeniedUser(user.id, door_id, token, reason, cb);
};
...
exports.logAllowedUser = function(user, door_id, token, cb) {
  ...
  doorserver.repositories.logRepository.logDeniedUser(user.id, door_id, token, cb);
};
