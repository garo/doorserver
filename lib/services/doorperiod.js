...
exports.checkSingleDoor = function(ts, door_id, cb) {
  ...
  exports.shouldDoorBeOpen(ts, door_id, function (err, shouldBeOpen, because_of_rule) {
    ...
    if (shouldBeOpen === true) {
      if (doorserver.services.door.isDoorOpen()) {
        console.log("Opening door", door_id, "because of periodic rule", because_of_rule);
      }
      ...
      if (!doorserver.services.door.isDoorOpen()) {
        console.log("Closing door", door_id, "because of periodic rule", because_of_rule);
      }
